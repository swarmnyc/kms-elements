...
function addPresenter(sessionId, ws, sdpOffer, callback) {
	...
	presenter.pipeline.create('WebRtcEndpoint', function(error, webRtcEndpoint) {
		...
		presenter.composite.createHubPort(function (error, _hubPort) {
			...
			_hubPort.setMaxOuputBitrate(parseInt(sessionId)+1024, function(err, id){
				_hubPort.getMaxOuputBitrate(function(err, id){
					console.log("hubPort.getMaxOuputBitrate(session id) = " + id);
				});
			});
